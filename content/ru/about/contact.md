---
title: "Контакты"
subtitle: "Оставайтесь на связи — все способы связаться с InnerSource Commons"
description: "Оставайтесь на связи с InnerSource Commons."
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6 order-2 order-md-2">
        <p>Самый быстрый и простой способ связаться с нами — присоединиться к Slack и задать вопрос в канале #general. 
        </p>
        <a href="/slack" class="btn btn-primary btn-sm"><img src="/images/slack.png" class="slack-tiny mr-2"/>Присоединиться к Slack</a>
        <p class="mt-4">Также можете написать на <a href="mailto:info@innersourcecommons.org">info@innersourcecommons.org</a>. </p>
      </div>
  ...
  <div class="container section-small shadow rounded-lg px-4 bg-light">
    <div class="row align-items-center justify-content-center text-center text-md-left">
      ...
      <div class="col-md-5 offset-md-1">
        <p class="h2 section-title">Оставайтесь на связи</p>
